...
Baseline on 2026-08-14, after the audit's §1–§4 work shipped: 376 passed, 0 failed, 3 notes, 1 known GAP (two customers sharing a phone share one invoice key — the colorComboKey gap has since closed). Plus 9 on gate A, 11 on the selector contract, and 12 on money parity.
...
Browser suite (`npm run test:browser`, run by hand — it is not in CI): 8 passed, 0 failed as of 2026-08-14. There are no known-red specs any more; see §9.14.
