...
| MON-02 | Where does the $30 change fee land if the invoice already went out? | Not sent → `changeFees` on the current invoice. Already sent → `carryoverCharge` on the customer, collected next season | 2026-08-21 | both money copies + parity | Standing |
...
| MON-06 | Does importing 960 customers open 960 windows? | No — only Add Customer opens one on joining | 2026-08-21 | (system-map §4) | Standing |
...
| MON-12 | Does the app ever recalculate a converted quote's price from feet? | **No, never.** The price they agreed to becomes `housePrice` — they are billed the number they saw and agreed to, and any hand-typed price survives conversion | 2026-08-26 | system-map §1; conversion path | Standing |
...
| # | Question | Her answer | Decided | Where it's proved | Status |
|---|---|---|---|---|---|
| WH-01 | One button for recycle-and-build, or two? | Two. "dont make it one button have one button for build and another for recycle." Neither may quietly do the other's half | 2026-08-21 | the two split buttons | Standing |
| WH-02 | Can somebody who moved be recycled without being deleted? | Yes — `recycleKeepingCustomer`. Mark Recycled has a mover branch that keeps them and their number | 2026-08-20 | mover branch of Mark Recycled | Standing |
| WH-03 | Should an add-on look different from a house on the sheet? | Yes, three signals: `Type: ADD-ON`, a note saying it goes in the bin they already have, and a badge | 2026-08-20 | warehouse tab + Printing tab copy | Standing |
...
| WH-09 | Does the recycle queue need colours and patterns? | No. "they just need the customer number and name." One flat list ordered by name | 2026-08-21 | recycle queue render | Standing |
...
| WH-12 | Is "soft" its own colour? | It counts as Warm White everywhere. She was asked and told the cost before reversing | 2026-08-24 | warehouse-colours.test.js | Standing |
...
| WH-16 | Can the build tab be asked about one house? | Yes — "i clicked build ashley wray but shes not here" was four different causes looking identical | 2026-08-21 | one-house lookup on the build tab | Standing |
| WH-17 | Should a blank colour field clear the build flag? | No. "big problem, she went to the recycle but not to the build." Blank colours mean the build can't be *done*, not that it isn't *owed* | 2026-08-21 | Edit Customer save | Standing |
...
| WH-19 | Buffer stock — does it carry a badge? | No. No customer, so no claim | 2026-08-24 | build-reason.test.js | Standing |
...
| CN-02 | Should converting ask before moving the number? | No — it moves automatically. The confirm existed only to protect the bin label, and `binLabelNumber` covers that now | 2026-08-21 | conversion path | Standing |
| CN-03 | Does a re-quote keep the old number? | Held only if feet stay below 260 with the addition — but the old number must stay findable either way | 2026-08-18 | number assignment on apply | Standing |
...
| # | Question | Her answer | Decided | Where it's proved | Status |
|---|---|---|---|---|---|
| QT-01 | Delete the customer and let the re-quote convert them back? | No — re-quotes get their own folder, and converting one *updates* | 2026-08-19 | re-quote folder | Standing |
...
| QT-03 | Price-only re-quote — does the warehouse do anything? | Nothing. Same house, same lights, same feet. It offers a box to explain the price change | 2026-08-21 | apply-re-quote branch | Standing |
...
| QT-06 | Can the office mark a quote approved without emailing it? | Yes — that *is* the override. Taken back if the answer is later changed | 2026-08-21 | quote card | Standing |
| QT-07 | What does the popup ask the warehouse after a re-quote? | Recycle old & build new / build the add-on (footage **typed**, not calculated) / nothing. The add-on is always offered | 2026-08-21 | apply-re-quote popup | Standing |
...
| QT-14 | Sides of the house — four names or a count? | A count, 1–4, so it matches the sheet. Front/left/right/back was a guess nobody could confirm | 2026-08-19 | quote form + portal radios | Standing |
...
| QT-16 | Nothing changed on a re-quote — is that a valid answer? | Yes, and it must not be a dead end. "to the system it looks like nothing changes" | 2026-08-21 | apply path | Standing |
...
| RS-05 | Does "Back Next Year" recycle? | No. Never sets `needsLightRecycle`; it is its own status value, not a flavour of "no" | 2026-08-14 | season-state.test.js | Standing |
| RS-06 | Is there a tag for never-asked vs asked-and-silent? | Yes — a third tag, **Unanswered**, distinct from blank. Everyone moves to Unanswered right before the RSVP goes out | 2026-08-20 | RSVP tags | Standing |
| RS-07 | Does an RSVP go to somebody who has never had lights? | No — choosing an RSVP template sets the audience to Returning by itself. A default, not a lock | 2026-08-19 | Automation Emails | Standing |
| RS-08 | Existing member approves — form, or portal? | Ask "do you want anything changed?" Yes → straight into the portal. No → a short message. A new member not yet converted still gets the form | 2026-08-19 | portal approve path | Standing |
...
| SCH-02 | How many towns can a crew have? | One dominant town plus at most one genuinely nearby — and the rule belongs to the **crew**, not the day | 2026-08-20 | crew→town map | Standing |
| SCH-03 | Top up from the nearest town, or the most urgent? | Most urgent | 2026-08-17 | top-up picker | Standing |
...
| SCH-13 | Which towns count as "close"? | No more than two per town, and actually close — "we dont want every city bordering each other" | 2026-08-20 | nearby-towns list | Standing |
| SCH-14 | Do one-man installs get their own tab? | Yes, and it stays in sync as the season moves | 2026-08-20 | One Man Installs tab | Standing |
...
| SCH-18 | Where does the route generator live? | In Schedule, and one button recalculates everything — two routes, one per crew, generated automatically | 2026-08-20 | Schedule commit | Standing |
| SCH-19 | Does the plan learn about customers added elsewhere? | Yes — the sync adds people it has never heard of, and pulls changes from all customers periodically | 2026-08-17/20 | five-minute sync | Standing |
...
| # | Question | Her answer | Decided | Where it's proved | Status |
|---|---|---|---|---|---|
| PR-01 | What does Print Today print? | Three papers: the warehouse list for **two days from now**, plus both crew lists for the next working day, each on its own page | 2026-08-20 | Printing tab | Standing |
...
| PR-03 | Is the crew portal in use this season? | No — "were not using the employee portal this year... we are only printing on schedules and warehouse." `employee.html` stays in the repo, dormant | 2026-08-21 | fix-sheet.test.js | Standing |
...
| DUP-05 | What do you call a website record the sheet doesn't have? | "instead of all those words where it says not on the sheet just call it duplicate" | 2026-08-19 | ledger wording | Standing |
| DUP-06 | Should the test customer use a fake address? | No — a real one, 209 S 850 W, Lehi. A fake address can't be geocoded, so a test record could never be routed or mapped, which is most of what it's for | 2026-08-21 | test-record builder | Standing |
| DUP-07 | Can test records be removed in one press? | Yes — customers, quotes, invoices, routes, schedule, warehouse and the recycle list, with the number put back | 2026-08-21 | Bulk Updates sweep | Standing |
...
| MSG-02 | Should the inbox look like Gmail? | Yes — "I want this to be very similar to gmail layout." Closed folder rolls its children up, open one does not; a zero draws as nothing | 2026-08-25 | Suite 273 | Standing |
| MSG-03 | Does Mark Responded also mark it read? | Yes. One direction only — Mark Awaiting does **not** put it back to unread | 2026-08-25 | messages panel | Standing |
