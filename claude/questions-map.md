...
| MON-21 | Somebody's lights went up and afterwards they said no for the season — do they get a bill? | **Yes — bill them for the work.** "Yes — bill them for the work." ⭐ So `completed` is tested ABOVE every answer, not one of them, and the rule is the sentence `pullCustomerFromSeason` always carried: work that was done is owed for, whatever they said afterwards. Supersedes the narrower reading in MON-15, which rescued Back Next Year and deliberately left a flat "no" alone because it had not been asked about | 2026-08-26 | `houseIsOnTheBill` / `houseIsOnTheBillServer`, money-parity | Standing |
